...
import first.service.DefaultCalendarService;
...
public class JdbcCalendarUserDao implements CalendarUserDao {
	private static final Logger logger = Logger.getLogger(JdbcCalendarUserDao.class);
	...
	public JdbcCalendarUserDao(JdbcOperations jdbcOperations) {
		logger.info("•••  criando JdbcCalendarUserDao");
	...
	static class CalendarUserRowMapper implements RowMapper<CalendarUser> {
		...
		/**
		 * Creates a new instance that allows for a custom prefix for the
		 * columnLabel.
		 *
